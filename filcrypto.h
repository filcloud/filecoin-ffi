...
void fil_destroy_post_config_response(fil_PoStConfigResponse *ptr);
...
fil_SealPreCommitPhase1Response *fil_generate_comm_d_tree(fil_RegisteredSealProof registered_proof,
                                                          const char *cache_dir_path,
...
fil_PoStConfigResponse *fil_post_config(fil_RegisteredPoStProof registered_proof);
...
fil_SealPreCommitPhase1Response *fil_seal_pre_commit_phase1_with_comm_d(fil_RegisteredSealProof registered_proof,
                                                                        const char *cache_dir_path,
                                                                        const char *staged_sector_path,
                                                                        const char *sealed_sector_path,
                                                                        uint64_t sector_id,
...
fil_StringResponse *fil_tree_prove(fil_32ByteArray randomness,
                                   const fil_PrivateReplicaInfo *replicas_ptr,
                                   size_t replicas_len,
                                   const uint64_t *j_ptr,
                                   size_t j_len,
                                   const uint64_t *i_ptr,
                                   size_t i_len,
                                   uint64_t num_sectors_per_chunk);
