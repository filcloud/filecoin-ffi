...
func FilGenerateWindowPost(randomness Fil32ByteArray, replicasPtr []FilPrivateReplicaInfo, replicasLen uint, proverId Fil32ByteArray, netRead FilNetReadCallback, treeCb FilMerkleTreeProofCallback) *FilGenerateWindowPoStResponse {
	...
	__ret := C.fil_generate_window_post(crandomness, creplicasPtr, creplicasLen, cproverId, cnetRead, ctreeCb)
...
// FilGenerateWinningPost function as declared in filecoin-ffi/filcrypto.h:391
func FilGenerateWinningPost(randomness Fil32ByteArray, replicasPtr []FilPrivateReplicaInfo, replicasLen uint, proverId Fil32ByteArray, netRead FilNetReadCallback, treeCb FilMerkleTreeProofCallback) *FilGenerateWinningPoStResponse {
	crandomness, crandomnessAllocMap := randomness.PassValue()
	creplicasPtr, creplicasPtrAllocMap := unpackArgSFilPrivateReplicaInfo(replicasPtr)
	creplicasLen, creplicasLenAllocMap := (C.size_t)(replicasLen), cgoAllocsUnknown
	cproverId, cproverIdAllocMap := proverId.PassValue()
	cnetRead, cnetReadAllocMap := netRead.PassValue()
	ctreeCb, ctreeCbAllocMap := treeCb.PassValue()
	__ret := C.fil_generate_winning_post(crandomness, creplicasPtr, creplicasLen, cproverId, cnetRead, ctreeCb)
	runtime.KeepAlive(ctreeCbAllocMap)
	runtime.KeepAlive(cnetReadAllocMap)
	runtime.KeepAlive(cproverIdAllocMap)
	runtime.KeepAlive(creplicasLenAllocMap)
...
// FilSealPreCommitPhase1WithCommD function as declared in filecoin-ffi/filcrypto.h:614
...
// FilSealPreCommitPhase2 function as declared in filecoin-ffi/filcrypto.h:630
...
// FilTreeProve function as declared in filecoin-ffi/filcrypto.h:635
func FilTreeProve(randomness Fil32ByteArray, replicasPtr []FilPrivateReplicaInfo, replicasLen uint, j uint64, i uint64, numSectorsPerChunk uint64) *FilStringResponse {
	crandomness, crandomnessAllocMap := randomness.PassValue()
	creplicasPtr, creplicasPtrAllocMap := unpackArgSFilPrivateReplicaInfo(replicasPtr)
	creplicasLen, creplicasLenAllocMap := (C.size_t)(replicasLen), cgoAllocsUnknown
	cj, cjAllocMap := (C.uintptr_t)(j), cgoAllocsUnknown
	...
	__ret := C.fil_tree_prove(crandomness, creplicasPtr, creplicasLen, cj, ci, cnumSectorsPerChunk)
